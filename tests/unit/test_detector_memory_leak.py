"""
tests/unit/test_detector_memory_leak.py
========================================
Unit tests for the memory_leak detector module.
...
from layer0.detectors.memory_leak import detect
...
class TestMemoryLeakDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """memory_leak must be registered in the DetectorRegistry."""
        self.assertIn('memory_leak', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "memory_leak")
