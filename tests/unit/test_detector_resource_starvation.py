"""
tests/unit/test_detector_resource_starvation.py
================================================
Unit tests for the resource_starvation detector module.
...
from layer0.detectors.resource_starvation import detect
...
class TestResourceStarvationDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """resource_starvation must be registered in the DetectorRegistry."""
        self.assertIn('resource_starvation', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "resource_starvation")
