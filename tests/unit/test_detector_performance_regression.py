"""
tests/unit/test_detector_performance_regression.py
====================================================
Unit tests for the performance_regression detector module.
...
from layer0.detectors.performance_regression import detect
...
class TestPerformanceRegressionDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """performance_regression must be registered in the DetectorRegistry."""
        self.assertIn('performance_regression', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "performance_regression")
