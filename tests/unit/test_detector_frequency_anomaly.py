"""
tests/unit/test_detector_frequency_anomaly.py
=============================================
Unit tests for the frequency_anomaly detector module.
...
from layer0.detectors.frequency_anomaly import detect
...
class TestFrequencyAnomalyDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """frequency_anomaly must be registered in the DetectorRegistry."""
        self.assertIn('frequency_anomaly', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "frequency_anomaly")
