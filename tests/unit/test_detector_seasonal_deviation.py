"""
tests/unit/test_detector_seasonal_deviation.py
===============================================
Unit tests for the seasonal_deviation detector module.
...
from layer0.detectors.seasonal_deviation import detect
...
class TestSeasonalDeviationDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """seasonal_deviation must be registered in the DetectorRegistry."""
        self.assertIn('seasonal_deviation', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "seasonal_deviation")
