"""
tests/unit/test_detector_cold_start.py
=======================================
Unit tests for the cold_start detector module.
...
from layer0.detectors.cold_start import detect
...
class TestColdStartDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """cold_start must be registered in the DetectorRegistry."""
        self.assertIn('cold_start', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "cold_start")
