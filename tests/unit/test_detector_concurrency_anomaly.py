"""
tests/unit/test_detector_concurrency_anomaly.py
=================================================
Unit tests for the concurrency_anomaly detector module.
...
from layer0.detectors.concurrency_anomaly import detect
...
class TestConcurrencyAnomalyDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """concurrency_anomaly must be registered in the DetectorRegistry."""
        self.assertIn('concurrency_anomaly', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "concurrency_anomaly")
