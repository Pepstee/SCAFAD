"""
tests/unit/test_detector_io_intensive.py
=========================================
Unit tests for the io_intensive detector module.
...
from layer0.detectors.io_intensive import detect
...
class TestIoIntensiveDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """io_intensive must be registered in the DetectorRegistry."""
        self.assertIn('io_intensive', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "io_intensive")
