"""
tests/unit/test_detector_dependency_failure.py
===============================================
Unit tests for the dependency_failure detector module.
...
from layer0.detectors.dependency_failure import detect
...
class TestDependencyFailureDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """dependency_failure must be registered in the DetectorRegistry."""
        self.assertIn('dependency_failure', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "dependency_failure")
