"""
tests/unit/test_detector_temporal_deviation.py
===============================================
Unit tests for the temporal_deviation detector module.
...
from layer0.detectors.temporal_deviation import detect
...
class TestTemporalDeviationDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """temporal_deviation must be registered in the DetectorRegistry."""
        self.assertIn('temporal_deviation', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "temporal_deviation")
