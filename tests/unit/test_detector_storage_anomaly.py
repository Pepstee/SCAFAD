"""
tests/unit/test_detector_storage_anomaly.py
============================================
Unit tests for the storage_anomaly detector module.
...
from layer0.detectors.storage_anomaly import detect
...
class TestStorageAnomalyDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """storage_anomaly must be registered in the DetectorRegistry."""
        self.assertIn('storage_anomaly', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "storage_anomaly")
