"""
tests/unit/test_detector_correlation_break.py
==============================================
Unit tests for the correlation_break detector module.
...
from layer0.detectors.correlation_break import detect
...
class TestCorrelationBreakDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """correlation_break must be registered in the DetectorRegistry."""
        self.assertIn('correlation_break', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "correlation_break")
