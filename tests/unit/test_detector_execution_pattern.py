"""
tests/unit/test_detector_execution_pattern.py
=============================================
Unit tests for the execution_pattern detector module.
...
from layer0.detectors.execution_pattern import detect
...
class TestExecutionPatternDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """execution_pattern must be registered in the DetectorRegistry."""
        self.assertIn('execution_pattern', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "execution_pattern")
