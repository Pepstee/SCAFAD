"""
tests/unit/test_detector_statistical_outlier.py
================================================
Unit tests for the statistical_outlier detector module.
...
from layer0.detectors.statistical_outlier import detect
...
class TestStatisticalOutlierDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """statistical_outlier must be registered in the DetectorRegistry."""
        self.assertIn('statistical_outlier', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "statistical_outlier")
