"""
tests/unit/test_detector_timeout_pattern.py
============================================
Unit tests for the timeout_pattern detector module.
...
from layer0.detectors.timeout_pattern import detect
...
class TestTimeoutPatternDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """timeout_pattern must be registered in the DetectorRegistry."""
        self.assertIn('timeout_pattern', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "timeout_pattern")
