"""
tests/unit/test_detector_security_anomaly.py
=============================================
Unit tests for the security_anomaly detector module.
...
from layer0.detectors.security_anomaly import detect
...
class TestSecurityAnomalyDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """security_anomaly must be registered in the DetectorRegistry."""
        self.assertIn('security_anomaly', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "security_anomaly")
