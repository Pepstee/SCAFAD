"""
tests/unit/test_detector_behavioral_drift.py
=============================================
Unit tests for the behavioral_drift detector module.
...
from layer0.detectors.behavioral_drift import detect
...
class TestBehavioralDriftDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """behavioral_drift must be registered in the DetectorRegistry."""
        self.assertIn('behavioral_drift', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "behavioral_drift")
