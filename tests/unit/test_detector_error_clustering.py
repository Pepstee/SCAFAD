"""
tests/unit/test_detector_error_clustering.py
=============================================
Unit tests for the error_clustering detector module.
...
from layer0.detectors.error_clustering import detect
...
class TestErrorClusteringDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """error_clustering must be registered in the DetectorRegistry."""
        self.assertIn('error_clustering', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "error_clustering")
