"""
tests/unit/test_detector_trend_change.py
=========================================
Unit tests for the trend_change detector module.
...
from layer0.detectors.trend_change import detect
...
class TestTrendChangeDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """trend_change must be registered in the DetectorRegistry."""
        self.assertIn('trend_change', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "trend_change")
