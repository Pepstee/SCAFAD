"""
tests/unit/test_detector_duration_outlier.py
============================================
Unit tests for the duration_outlier detector module.
...
from layer0.detectors.duration_outlier import detect
...
class TestDurationOutlierDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """duration_outlier must be registered in the DetectorRegistry."""
        self.assertIn('duration_outlier', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "duration_outlier")
