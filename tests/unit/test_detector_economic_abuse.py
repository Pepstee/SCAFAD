"""
tests/unit/test_detector_economic_abuse.py
===========================================
Unit tests for the economic_abuse detector module.
...
from layer0.detectors.economic_abuse import detect
...
class TestEconomicAbuseDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """economic_abuse must be registered in the DetectorRegistry."""
        self.assertIn('economic_abuse', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "economic_abuse")
