"""
tests/unit/test_detector_network_anomaly.py
============================================
Unit tests for the network_anomaly detector module.
...
from layer0.detectors.network_anomaly import detect
...
class TestNetworkAnomalyDetector(unittest.TestCase):
    ...
    def test_registered_in_registry(self):
        """network_anomaly must be registered in the DetectorRegistry."""
        self.assertIn('network_anomaly', REGISTRY)
    ...
    def test_returns_detection_result_with_no_history(self):
        ...
        self.assertEqual(result.algorithm_name, "network_anomaly")
